...
<html lang="en">
  ...
  >
          ...
          >
            <div>
              ...
              <div>
                ...
                <?php if ($error): ?>
                <div class="mb-5 flex w-full border-l-6 border-error bg-error-50 px-7 py-4 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-5">
                  <div class="mr-5 flex h-9 w-9 items-center justify-center rounded-lg bg-error-500/20" style="width: 36px; height: 36px; min-width: 36px;">
                    <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M6.4917 7.65579L11.106 12.2645C11.2545 12.4128 11.4715 12.5 11.6738 12.5C11.8762 12.5 12.0931 12.4128 12.2416 12.2645C12.5621 11.9445 12.5623 11.4317 12.2423 11.1114C12.2422 11.1113 12.2422 11.1112 12.2422 11.1111L7.6279 6.50239L12.2422 1.89367C12.5623 1.5736 12.5623 1.0607 12.2422 0.740632C11.922 0.420565 11.4093 0.420565 11.0892 0.740632L6.4917 5.34935L1.8774 0.740632C1.5573 0.420565 1.0445 0.420565 0.7244 0.740632C0.4043 1.0607 0.4043 1.5736 0.7244 1.89367L5.3554 6.50239L0.7244 11.1111C0.4043 11.4312 0.4043 11.9441 0.7244 12.2641C1.0445 12.5842 1.5573 12.5842 1.8774 12.2641L6.4917 7.65579Z" fill="#F23030"/>
                    </svg>
                  </div>
                  <div class="w-full">
                    <h5 class="mb-3 text-lg font-semibold text-[#B45454]">Error</h5>
                    <p class="text-base leading-relaxed text-[#CD5D5D]"><?= htmlspecialchars($error) ?></p>
                  </div>
                </div>
                <?php endif; ?>
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <div class="block mb-4">
                <img src="src/images/logo/gridwave-logo.png" alt="Logo" class="h-20" />
              </div>
    ...
    <!-- ===== Page Wrapper End ===== -->
    <!-- Hidden elements to satisfy bundle.js console errors -->
