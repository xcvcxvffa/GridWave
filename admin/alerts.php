          ...
          <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
            ...
            <div class="space-y-5 sm:space-y-6">
              ...
              >
                ...
                >
                  <div class="space-y-6">
                    <?php include __DIR__ . '/src/partials/alert/alert-success.html'; ?></div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <div class="space-y-6">
                    <?php include __DIR__ . '/src/partials/alert/alert-warning.html'; ?></div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <div class="space-y-6">
                    <?php include __DIR__ . '/src/partials/alert/alert-error.html'; ?></div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <div class="space-y-6">
                    <?php include __DIR__ . '/src/partials/alert/alert-info.html'; ?></div>
                </div>
              </div>
            </div>
          </div>
