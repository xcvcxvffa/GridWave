          ...
          <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
            ...
            <div class="space-y-5 sm:space-y-6">
              ...
              >
                ...
                >
                  <?php include __DIR__ . '/src/partials/grid-image/image-01.html'; ?></div>
              </div>
              ...
              >
                ...
                <div
                  class="p-4 border-t border-gray-100 dark:border-gray-800 sm:p-6"
                >
                  <?php include __DIR__ . '/src/partials/grid-image/image-02.html'; ?></div>
              </div>
              ...
              >
                ...
                <div
                  class="p-4 border-t border-gray-100 dark:border-gray-800 sm:p-6"
                >
                  <?php include __DIR__ . '/src/partials/grid-image/image-03.html'; ?></div>
              </div>
            </div>
          </div>
        </main>
