  ...
  >
    ...
    >
      ...
      <a href="index.php" class="lg:hidden">
        <img class="dark:hidden h-14 w-auto" src="src/images/logo/black-logo.png" alt="Logo" />
        <img
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="<?= htmlspecialchars($_SESSION['user_data']['avatar'] ?: 'src/images/user/owner.jpg') ?>" alt="User" />
          </span>

          <span class="text-theme-sm mr-1 block font-medium"> <?= htmlspecialchars($_SESSION['user_data']['first_name'] ?: 'User') ?> </span>
        ...
        >
          <div>
            ...
            >
              <?= htmlspecialchars(trim(($_SESSION['user_data']['first_name'] ?? 'User') . ' ' . ($_SESSION['user_data']['last_name'] ?? ''))) ?>
            </span>
            <span
