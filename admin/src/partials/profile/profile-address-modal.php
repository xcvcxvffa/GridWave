...
>
  ...
  >
    ...
    <form class="flex flex-col" action="update_address.php" method="POST">
        ...
        <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
          <div>
            ...
            <input
              type="text"
              name="country"
              value="<?= htmlspecialchars($_SESSION['user_data']['country'] ?? '') ?>"
          ...
          <div>
            ...
            <input
              type="text"
              name="city_state"
              value="<?= htmlspecialchars($_SESSION['user_data']['city_state'] ?? '') ?>"
          ...
          <div>
            ...
            <input
              type="text"
              name="postal_code"
              value="<?= htmlspecialchars($_SESSION['user_data']['postal_code'] ?? '') ?>"
          ...
          <div>
            ...
            <input
              type="text"
              name="office_address"
              value="<?= htmlspecialchars($_SESSION['user_data']['office_address'] ?? '') ?>"
