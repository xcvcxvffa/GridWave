...
<html lang="en">
  ...
  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p
                          class="text-sm font-medium text-gray-800 dark:text-white/90"
                        >
                          <?= htmlspecialchars($_SESSION['user_data']['office_address'] ?? '') ?>
                        </p>
                      </div>
    ...
    <!-- BEGIN MODAL -->
    <?php include __DIR__ . '/src/partials/profile/profile-info-modal.php'; ?><?php include __DIR__ . '/src/partials/profile/profile-address-modal.php'; ?><?php include __DIR__ . '/src/partials/profile/change-password-modal.php'; ?><!-- END MODAL -->
  </body>
</html>
